/** 
 * En esta version numero 2 tomare el codigo funcional de la practica producto escalar
 * y lo optimizare segun recomendaciones del maestro y tomando de referencia videos
 * de clases anteriores, tomando en cuenta que hay variables que se generan en todos los 
 * procesos cuando solo se necesita que se generen en el proceso raiz
*/
